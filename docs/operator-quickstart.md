# Operator Quickstart — Manufacture of Metal-Forming Machinery and Machine Tools

Shortest path from clone to a verified local dry-run for **ISIC 2822** (`cloud-itonami-isic-2822`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2822.git
cd cloud-itonami-isic-2822
```
...
- Blueprint governor key: `machinetool-governor`
- Likely source path: `machinetool.governor.cljc`
